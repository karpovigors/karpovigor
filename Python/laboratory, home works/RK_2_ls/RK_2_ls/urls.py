...
router.register(r'teachers', app_views.TeacherViewSet)
...
urlpatterns = [
    ...
    path('app/t_list', app_views.TeacherList),
    path('app/c/<int:course_id>', app_views.CourseView, name='course_detail'),
    path('app/t/<int:teacher_id>', app_views.TeacherView, name='teacher_detail')
]
